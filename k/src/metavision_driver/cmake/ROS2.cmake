...
option(KRIA_MANUAL_ROS2_DEPENDENCIES
  "Use direct target dependencies instead of ament_auto transitive Python dependencies"
  ON)
if(NOT KRIA_MANUAL_ROS2_DEPENDENCIES)
...
ament_target_dependencies(driver_ros2 ${ROS2_DEPENDENCIES})
...
ament_target_dependencies(driver_node ${ROS2_DEPENDENCIES})
target_include_directories(driver_node PRIVATE include)
target_link_libraries(driver_node driver_ros2 ${MV_COMPONENTS_QUAL})
