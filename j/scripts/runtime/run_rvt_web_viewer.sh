...
exec docker run --rm --runtime nvidia --network host \
  ...
  rvt:jetson bash -lc '
    ...
    export PYTHONPATH=/opt/ros/humble/local/lib/python3.10/dist-packages:/opt/ros/humble/lib/python3.10/site-packages:/home/anavs/ROS2/j/install/rvt_live_inference/local/lib/python3.10/dist-packages:/home/anavs/ROS2/j/install/jetson_evt21_decoder/local/lib/python3.10/dist-packages
    ...
    exec python3 /home/anavs/ROS2/j/install/rvt_live_inference/lib/rvt_live_inference/rvt_web_viewer.py
  '
